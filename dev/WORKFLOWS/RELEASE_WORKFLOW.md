...
3. **[Cursor]** Run `/release-new {version}` → creates `dev/RELEASES/RELEASE_v{version}.md`
...
| Step | Command | Output |
|------|---------|--------|
| 3 | `/release-new {version}` | `dev/RELEASES/RELEASE_v{version}.md` |
...
| `dev/RELEASES/RELEASE_v{version}.md` | Release notes |
