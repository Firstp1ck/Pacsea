...
impl Default for AppState {
    ...
    fn default() -> Self {
        ...
        let (
            ...
            news_button_rect,
            updates_loading,
            updates_last_check_authoritative,
            refresh_updates,
        ...
        let (
            ...
            pkgb_section_cycle,
            pkgb_rect,
            pkgb_run_checks_button_rect,
            pkgb_check_status,
            pkgb_check_findings,
            pkgb_check_raw_results,
            pkgb_check_missing_tools,
            pkgb_check_show_raw_output,
            pkgb_check_scroll,
            pkgb_check_raw_scroll,
            pkgb_check_last_package_name,
            pkgb_check_last_run_at,
            pkgb_check_last_error,
        ...
        let (
            ...
            optional_deps_modal_rect,
            system_update_modal_rect,
            repositories_modal_rect,
            ssh_setup_copy_key_rect,
        ...
        Self {
            ...
            updates_modal_pending_g_at: None,
            help_scroll,
            help_rect,
            preflight_tab_rects,
            preflight_content_rect,
            ...
            pending_repo_apply_overlap_check: None,
            pending_repositories_modal_resume: None,
            pending_foreign_migrate_commands: None,
            pending_foreign_migrate_summary: None,
            skip_aur_repo_dup_warning_once: false,
